        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown d-inline-flex">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    <li><a class="dropdown-item" href="{{route("myaccount")}}"><i class="far fa-user-circle mr-1"></i>My account</a></li>
                    <li><a class="dropdown-item" href="{{route("admin_logout")}}"><i class="fas fa-sign-out-alt mr-1"></i>Logout</a></li>
                </ul>
                @endauth
                @guest
