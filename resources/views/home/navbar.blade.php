        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    <li><a class="dropdown-item" href="{{route("profile")}}"><i class="far fa-user-circle"></i>My account</a></li>
                    <li><a class="dropdown-item" href="{{route("admin_logout")}}"><i class="fas fa-sign-out-alt"></i>Logout</a></li>
                </ul>
                @endauth
                @guest
            <li><a class="nav-link" href="{{route("admin_login")}}"><i class="fas fa-sign-in-alt"></i>Login</a></li>
